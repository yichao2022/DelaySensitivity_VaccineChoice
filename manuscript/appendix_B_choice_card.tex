...
\begin{figure}[H]
    ...
    \begin{tabular}{lcc}
      ...
      \midrule
      Waiting time to vaccination & 0 months & 3 months \\
      Vaccine efficacy & 50\% & 95\% \\
      Side-effect profile & Moderate (fever 2 days) & Moderate (fever 2 days) \\
      Cash incentive & 200 RMB & 50 RMB \\
      Vaccine origin & Imported & Domestic \\
      \midrule
      \multicolumn{3}{l}{( ) Vaccine A\hspace{2em}( ) Vaccine B\hspace{2em}( ) I would not choose either vaccine}
    \end{tabular}
    \vspace{2ex}
\end{figure}
