...
For completeness, we report the monthly monetary equivalents (MWTA) computed from the subgroup-specific mixed logit estimates in Appendix~F (500 Halton draws, respondent-level panel). The full-sample estimate is 99 RMB/month; subgroup estimates are 61 RMB/month (high trust), 97 RMB/month (low trust), and 210 RMB/month (neutral trust). These point estimates are descriptive: the continuous trust specification did not support systematic moderation (linear interaction $p = 0.15$; quadratic-vs-linear LR $p = 0.27$), and we do not interpret the subgroup MWTA differences as evidence of systematic trust moderation.
